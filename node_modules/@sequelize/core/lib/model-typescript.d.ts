...
import type { AbstractQueryGenerator, AbstractQueryInterface, Association, AttributeOptions, Attributes, BrandedKeysOf, BuiltModelOptions, FindByPkOptions, ForeignKeyBrand, IndexOptions, InitOptions, ModelAttributes, ModelStatic, NormalizedAttributeOptions, Sequelize, TableNameWithSchema } from '.';
...
export declare class ModelTypeScript {
     ...
     * @returns
     */
    static findByPk<M extends Model>(this: ModelStatic<M>, param: number | bigint | string | Buffer | object, options?: FindByPkOptions<Attributes<M>>): Promise<Model | null>;
}
